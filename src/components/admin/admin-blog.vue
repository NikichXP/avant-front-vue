...
<!--        <h4 class="admin-header">Чтиво</h4>-->
        <div class="admin-toolbar">
          <div class="buttons">
            <router-link class="admin-button" to='/admin/blog/edit/new'>Новый пост</router-link>  
          </div>
        ...
        <table class="admin-table table table-striped table-condensed">
          ...
          <tbody>
            <tr v-for="(event, index) in eventsList" v-bind:key='event.id' @click="openEditMenu('/admin/blog/edit/' + event.id)">
